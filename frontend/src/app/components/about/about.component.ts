...
export class AboutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.seoService.setDescription($localize`:@@meta.description.about:Learn more about HAUS HOPPE\: enterprise sponsors, individual sponsors, integrations, who contributes, FOSS licensing, and more.`);
