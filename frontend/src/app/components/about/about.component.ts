...
export class AboutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.seoService.setDescription($localize`:@@meta.description.about:'Your favorite MEMEpool explorer. Inscriptions, Stamps, Runes, and 😺 CAT-21 Ordinals? We have you covered!`);
