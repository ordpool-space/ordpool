...
export class TrademarkPolicyComponent {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription('An overview of the trademarks registered by Mempool Space K.K. and ordpool.space and what we consider to be lawful usage of those trademarks.');
  }
}
